...
;Typical usage
;-------------------------------------------------------------------------------
;		ldx #>source		;Prepare the source pointer. This is not
;		stx lz_sector_ptr1+1	;required when loading from a static
;		stx lz_sector_ptr2+1	;sector buffer
;		stx lz_sector_ptr3+1
;
;		ldx #<target		;Set the target buffer address
;		stx lz_dst+0
;		ldx #>target
;		stx lz_dst+1
;
;					;Start reading from the first byte
;		ldx #$00		;of the first sector, which is
;					;supposed to have been loaded already
;
;		;Fallthrough
;		; .
;		; .
